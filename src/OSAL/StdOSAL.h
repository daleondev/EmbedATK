...
// bool StdMessageQueue<T, N>::empty() const 
// {  
...
// template <typename T, size_t N>
// bool StdMessageQueue<T, N>::push(const T& msg) 
// { 
...
// }
// template <typename T, size_t N>
// bool StdMessageQueue<T, N>::push(T&& msg) 
// { 
...
//     if constexpr (std::is_copy_constructible_v<T> && std::is_copy_assignable_v<T>) {
//         {
//             std::lock_guard<std::mutex> lock(m_mutex); // TODO
//             if (m_queue.size() + data.size() > N)
//                 return false;
...
// }
// template <typename T, size_t N>
// std::optional<T> StdMessageQueue<T, N>::pop()
// {
...
// }
// template <typename T, size_t N>
// std::optional<T> StdMessageQueue<T, N>::tryPop()
// {
//     std::unique_lock<std::mutex> lock(m_mutex);
//     return m_queue.pop();
// }
